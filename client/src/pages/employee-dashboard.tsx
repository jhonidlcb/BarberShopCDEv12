  ...
  const handlePaymentConfirm = async (amount: number, currency: string, employeeId?: string) => {
    ...
    try {
      ...
      toast({ 
        ...
        description: 'Hubo un problema al completar la cita.',
        variant: 'destructive' 
      });
    }
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 border border-white/20">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-purple-200">Ingresos</p>
                <p className="text-2xl font-bold text-white">${stats?.totalRevenue || '0.00'}</p>
              </div>
            </div>
          </div>
        </div>
