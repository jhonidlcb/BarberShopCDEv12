                  ...
                  {appointment.attendedByEmployeeId ? (
                    <div className="flex flex-col">
                      <span className="text-green-400 font-medium">
                        {employees?.find(e => e.id === appointment.attendedByEmployeeId)?.username || 'Empleado no encontrado'}
                      </span>
                      {employees?.find(e => e.id === appointment.attendedByEmployeeId)?.staffMember?.name && (
